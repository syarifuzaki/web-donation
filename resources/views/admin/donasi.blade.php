@push('metas')
  <title>Admin Donasis | Kafa-ka.com</title>
@endpush
...
@section('content')
  ...
  <div class="header-holder header-holder-desktop">
    <div class="header-container container-fluid g-4">
      <h4 class="header-title">List Donasi</h4>
      ...
      <div class="header-wrap header-wrap-block justify-content-start">
        ...
        <div class="breadcrumb breadcrumb-transparent mb-0">
          ...
          <a href="{{ route('admin.donasi') }}" class="breadcrumb-item">
            <span class="breadcrumb-text">Donasi</span>
          </a>
        </div>
        <!-- END Breadcrumb -->
      </div>
        ...
        <div class="col-12">
          ...
          <div class="portlet">
            <div class="portlet-header portlet-header-bordered">
              <h3 class="portlet-title">List Donasi</h3>
            </div>
