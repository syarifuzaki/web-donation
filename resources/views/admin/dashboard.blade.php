@push('metas')
  <title>Admin Dashboard | Kafa-ka.com</title>
@endpush
                    ...
                    <div class="rich-list">
                      <div class="rich-list-item">
                        <div class="rich-list-prepend">
                          ...
                          <div class="avatar">
                            <div class="avatar-display">
                              <img src="assets/images/avatar/" alt="Avatar image">
                            </div>
                          </div>
                          <!-- END Avatar -->
                        </div>
...
@push('script')
	<script type="text/javascript" src="{{ url('assets/app/pages/home.js') }}"></script>
@endpush